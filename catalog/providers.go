...
var builtInProviders = []Provider{
	...
	providerCatalogEntry(providerSeed{
		...
		specs: []SpecReference{
			...
			humanDocsRef("intercom-rest-api-docs", "https://developers.intercom.com/docs/references/rest-api/api.intercom.io", "Official Intercom REST API reference documentation."),
			humanDocsRef("intercom-auth-docs", "https://developers.intercom.com/docs/build-an-integration/learn-more/authentication", "Official Intercom developer authentication documentation for private app access tokens and OAuth apps."),
			humanDocsRef("intercom-openapi-tools-docs", "https://developers.intercom.com/docs/build-an-integration/learn-more/rest-apis/sdks-plugins", "Official Intercom SDK and developer tooling documentation describing the Intercom OpenAPI specification."),
		},
