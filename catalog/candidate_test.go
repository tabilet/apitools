...
func TestFindBuiltInCandidateMatchesAliases(t *testing.T) {
	tests := []struct {
		...
		{key: "acumatica openapi", id: "acumatica"},
		...
		{key: "bigcommerce store api", id: "bigcommerce"},
		...
		{key: "cisco meraki api", id: "cisco-meraki"},
		{key: "clearbit prospector", id: "clearbit"},
		{key: "clockify api", id: "clockify"},
		{key: "coda docs", id: "coda"},
		{key: "coin gecko", id: "coingecko"},
		{key: "atlassian confluence api", id: "confluence-cloud"},
		{key: "confluent kafka api", id: "confluent-cloud"},
		...
		{key: "docusign esignature api", id: "docusign"},
