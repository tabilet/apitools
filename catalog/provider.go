...
const (
	...
	SpecKindOpenRPC         SpecKind = "openrpc"
	SpecKindGraphQL         SpecKind = "graphql"
	SpecKindGRPCProtobuf    SpecKind = "grpc-protobuf"
	SpecKindOData           SpecKind = "odata"
...
func (p Provider) hasMachineSpecKind() bool {
	return p.hasSpecKind(SpecKindDropboxStone, SpecKindGoogleDiscovery, SpecKindSmithyJSON, SpecKindAsyncAPI, SpecKindOpenRPC, SpecKindGraphQL, SpecKindGRPCProtobuf, SpecKindOData)
}
...
func validSpecKind(value SpecKind) bool {
	switch value {
	case SpecKindOpenAPI, SpecKindOpenAPIIndex, SpecKindDropboxStone, SpecKindGoogleDiscovery, SpecKindSmithyJSON, SpecKindAsyncAPI, SpecKindOpenRPC, SpecKindGraphQL, SpecKindGRPCProtobuf, SpecKindOData, SpecKindHumanDocs:
		return true
	default:
		return false
	}
