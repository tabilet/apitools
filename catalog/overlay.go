...
var builtInSecurityOverlays = []SecurityOverlay{
		...
		SecuritySchemes: []SecurityScheme{
			{
				...
				Scheme:      "basic",
				Description: "Amplitude API key and secret key supplied with HTTP Basic authentication for API families that require paired project credentials.",
			},
			{
				...
				Description:   "Amplitude project API key supplied as an api_key request parameter for ingestion-style API families.",
			},
			{
				Name:         "amplitudeBearer",
				Type:         SecuritySchemeHTTP,
				Scheme:       "bearer",
				BearerFormat: "Amplitude API token",
				Description:  "Amplitude management or access token supplied as an Authorization bearer token where supported.",
			},
		},
		RootSecurity: []SecurityRequirement{{Scheme: "amplitudeBasic"}, {Scheme: "amplitudeAPIKey"}, {Scheme: "amplitudeBearer"}},
		SourceRefs: []string{
			"https://amplitude.com/docs/apis/authentication",
			"https://amplitude.com/docs/apis/keys-and-tokens",
		},
		SourceNote: "Amplitude has multiple official API families but no recorded provider-wide OpenAPI artifact; docs describe family-specific Basic, api_key, and bearer-token authentication forms, so this advisory overlay records alternatives only.",
	},
	{
		ID:         "anthropic-api-auth-overlay",
		...
		SecuritySchemes: []SecurityScheme{{
			...
			Description:   "Anthropic API key supplied in the x-api-key request header.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "anthropicAPIKey"}},
		SourceRefs: []string{
			"https://platform.claude.com/docs/en/api/authentication",
			"https://platform.claude.com/docs/en/api/messages",
		},
		SourceNote: "Anthropic has official API docs but no recorded stable public OpenAPI artifact; docs describe x-api-key authentication and this overlay remains metadata-only without modeling prompt execution endpoints.",
	},
	{
		ID:         "ashby-api-auth-overlay",
		ProviderID: "ashby",
		...
		SecuritySchemes: []SecurityScheme{{
			...
			Type:        SecuritySchemeHTTP,
			Scheme:      "basic",
			Description: "Ashby API key supplied through HTTP Basic authentication according to Ashby API documentation.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "ashbyBasic"}},
		SourceRefs: []string{
			"https://developers.ashbyhq.com/docs/authentication",
			"https://developers.ashbyhq.com/docs/introduction",
		},
		SourceNote: "Ashby has official human API docs but no recorded stable provider-wide OpenAPI artifact; docs describe Basic authentication with API-key credentials, retained here as advisory metadata only.",
	},
	{
	...
	{
		ID:         "braze-api-auth-overlay",
		ProviderID: "braze",
		SpecRefID:  "braze-api-basics",
		Status:     AuthStatusOverlayRequired,
		SecuritySchemes: []SecurityScheme{{
			Name:         "brazeRESTAPIKey",
			Type:         SecuritySchemeHTTP,
			Scheme:       "bearer",
			BearerFormat: "Braze REST API key",
			Description:  "Braze REST API key supplied as an Authorization bearer token.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "brazeRESTAPIKey"}},
		SourceRefs: []string{
			"https://www.braze.com/docs/api/basics",
			"https://www.braze.com/docs/api/endpoints/user_data/post_user_track",
		},
		SourceNote: "Braze has official human REST API docs but no recorded stable provider-wide OpenAPI artifact; docs describe Authorization bearer REST API key metadata for endpoint families.",
	},
	{
	...
	{
		ID:         "toggl-track-api-auth-review",
		ProviderID: "toggl",
		...
		SecuritySchemes: []SecurityScheme{{
			...
			Type:        SecuritySchemeHTTP,
			Scheme:      "basic",
			Description: "Toggl Track HTTP Basic authentication using either email/password or the user's API token as the username with api_token as the password.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "BasicAuth"}},
		SourceRefs: []string{
			"https://engineering.toggl.com/assets/files/api-e95bb70f0fdd53fbd754f1dcf1041a9f.json",
			"https://engineering.toggl.com/docs/track/openapi/",
			"https://engineering.toggl.com/docs/track/authentication/",
			"https://engineering.toggl.com/docs/track/api/authentication/",
		},
		SourceNote: "Toggl's official Track Swagger artifact declares BasicAuth and references OAuth2 on some operations without declaring that OAuth2 security definition; official docs describe Basic auth with email/password or API-token credentials, so this review overlay records both names while preserving present-incomplete status.",
	},
	{
	...
	{
		ID:         "humantic-ai-api-auth-overlay",
		ProviderID: "humantic-ai",
		SpecRefID:  "humantic-ai-api-root",
		Status:     AuthStatusOverlayRequired,
		SecuritySchemes: []SecurityScheme{{
			Name:          "humanticAIAPIKey",
			Type:          SecuritySchemeAPIKey,
			In:            APIKeyInQuery,
			ParameterName: "apikey",
			Description:   "Humantic AI API key carried in the apikey query parameter.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "humanticAIAPIKey"}},
		SourceRefs: []string{
	...
	},
	{
		...
		SecuritySchemes: []SecurityScheme{{
			...
			In:            APIKeyInQuery,
			ParameterName: "api_key",
			Description:   "Hunter API key carried in the api_key query parameter.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "hunterAPIKey"}},
		SourceRefs: []string{
	...
	},
	{
		...
		SecuritySchemes: []SecurityScheme{{
			...
			Type:         SecuritySchemeHTTP,
			Scheme:       "bearer",
			BearerFormat: "Jina AI API key",
			Description:  "Jina AI API key carried in the Authorization bearer header.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "jinaBearer"}},
		SourceRefs: []string{
	...
	{
		ID:         "lingvanex-api-auth-overlay",
		ProviderID: "lingvanex",
		SpecRefID:  "lingvanex-api-docs",
		Status:     AuthStatusOverlayRequired,
		SecuritySchemes: []SecurityScheme{{
			Name:         "lingvaNexBearer",
			Type:         SecuritySchemeHTTP,
			Scheme:       "bearer",
			BearerFormat: "LingvaNex API key",
			Description:  "LingvaNex API key carried in the Authorization bearer header.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "lingvaNexBearer"}},
		SourceRefs: []string{
			"https://docs.lingvanex.com/reference/user-guide",
			"https://github.com/lingvanex-mt/python-translation-api",
		},
	...
	{
		ID:         "mistral-ai-api-auth-overlay",
		...
		SecuritySchemes: []SecurityScheme{{
			...
			Type:         SecuritySchemeHTTP,
			Scheme:       "bearer",
			BearerFormat: "Mistral AI API key",
			Description:  "Mistral AI API key carried in the Authorization bearer header.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "mistralBearer"}},
		SourceRefs: []string{
		...
		SecuritySchemes: []SecurityScheme{
			{
				...
				In:            APIKeyInHeader,
				ParameterName: "Authorization",
				Description:   "Mindee v1 product API key carried in the Authorization header using Token syntax.",
			},
			{
				Name:          "mindeeInferuserToken",
				Type:          SecuritySchemeAPIKey,
				In:            APIKeyInHeader,
				ParameterName: "X-Inferuser-Token",
				Description:   "Mindee legacy product API key carried in the X-Inferuser-Token header.",
			},
		},
		RootSecurity: []SecurityRequirement{{Scheme: "mindeeV1Token"}, {Scheme: "mindeeInferuserToken"}},
		SourceRefs: []string{
	...
	{
		ID:         "phantombuster-api-auth-overlay",
		...
		SecuritySchemes: []SecurityScheme{{
			...
			Type:          SecuritySchemeAPIKey,
			In:            APIKeyInHeader,
			ParameterName: "X-Phantombuster-Key",
			Description:   "Phantombuster API key carried in the X-Phantombuster-Key header.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "phantombusterAPIKey"}},
		SourceRefs: []string{
	...
	},
	{
		...
		SecuritySchemes: []SecurityScheme{{
			...
			In:            APIKeyInHeader,
			ParameterName: "Authorization",
			Description:   "UpLead API key carried in the Authorization header.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "upleadAPIKey"}},
		SourceRefs: []string{
			"https://docs.uplead.com/",
		},
	...
	{
		ID:         "dropcontact-api-auth-overlay",
		ProviderID: "dropcontact",
		SpecRefID:  "dropcontact-api-docs",
		Status:     AuthStatusOverlayRequired,
		SecuritySchemes: []SecurityScheme{{
			Name:          "dropcontactAccessToken",
			Type:          SecuritySchemeAPIKey,
			In:            APIKeyInHeader,
			ParameterName: "X-Access-Token",
			Description:   "Dropcontact API key carried in the X-Access-Token header.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "dropcontactAccessToken"}},
		SourceRefs: []string{
		...
		SecuritySchemes: []SecurityScheme{
			{
				...
				Type:          SecuritySchemeAPIKey,
				In:            APIKeyInQuery,
				ParameterName: "mocean-api-key",
				Description:   "Mocean API key carried in the mocean-api-key request parameter.",
			},
			{
				Name:          "moceanAPISecret",
				Type:          SecuritySchemeAPIKey,
				In:            APIKeyInQuery,
				ParameterName: "mocean-api-secret",
				Description:   "Mocean API secret carried in the mocean-api-secret request parameter.",
			},
		},
		RootSecurity: []SecurityRequirement{{Scheme: "moceanAPIKey"}, {Scheme: "moceanAPISecret"}},
		RootSecuritySets: []SecurityRequirementSet{{
			Requirements: []SecurityRequirement{{Scheme: "moceanAPIKey"}, {Scheme: "moceanAPISecret"}},
		}},
		SourceRefs: []string{
			"https://moceanapi.com/docs",
		},
		SourceNote: "Mocean has official human API docs but no recorded stable public official OpenAPI document; API key and API secret request parameter metadata comes from advisory overlay notes.",
	},
	{
		ID:         "msg91-api-auth-overlay",
		ProviderID: "msg91",
		...
		SecuritySchemes: []SecurityScheme{{
			...
			Description:   "MSG91 authentication key carried in the authkey request parameter for legacy SMS endpoints.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "msg91AuthKey"}},
		SourceRefs: []string{
			"https://docs.msg91.com/sms",
			"https://docs.msg91.com/overview",
		},
		SourceNote: "MSG91 has official human API docs but no recorded stable public official OpenAPI document; authkey metadata comes from advisory overlay notes.",
	},
	{
		ID:         "plivo-api-auth-overlay",
		ProviderID: "plivo",
		...
		SecuritySchemes: []SecurityScheme{{
			...
			Type:        SecuritySchemeHTTP,
			Scheme:      "basic",
			Description: "Plivo Auth ID and Auth Token carried with HTTP Basic authentication.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "plivoBasic"}},
		SourceRefs: []string{
			"https://www.plivo.com/docs/messaging/api/message/retrieve-a-message",
			"https://www.plivo.com/docs/voice/api/call/the-call-object/",
		},
		SourceNote: "Plivo has official human API docs but no recorded stable public official OpenAPI document; HTTP Basic Auth ID/Auth Token metadata comes from advisory overlay notes.",
	},
	{
		ID:         "pushbullet-api-auth-overlay",
		ProviderID: "pushbullet",
		SpecRefID:  "pushbullet-api-docs",
		Status:     AuthStatusOverlayRequired,
		SecuritySchemes: []SecurityScheme{{
			Name:         "pushbulletBearer",
			Type:         SecuritySchemeHTTP,
			Scheme:       "bearer",
			BearerFormat: "Pushbullet OAuth2 access token",
			Description:  "Pushbullet OAuth2 access token carried in the Authorization bearer header.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "pushbulletBearer"}},
		SourceRefs: []string{
			"https://docs.pushbullet.com/",
		},
		SourceNote: "Pushbullet has official human API docs but no recorded stable public official OpenAPI document; OAuth2 bearer metadata comes from advisory overlay notes.",
	},
	{
		ID:         "pushcut-api-auth-overlay",
		ProviderID: "pushcut",
		...
		SecuritySchemes: []SecurityScheme{{
			...
			In:            APIKeyInHeader,
			ParameterName: "API-Key",
			Description:   "Pushcut API key carried in the API-Key header.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "pushcutAPIKey"}},
		SourceRefs: []string{
			"https://www.pushcut.io/support/integrations",
			"https://www.pushcut.io/support/notifications",
		},
		SourceNote: "Pushcut has official human API docs but no recorded stable public official OpenAPI document; API-Key header metadata comes from advisory overlay notes.",
	},
	{
		ID:         "pushover-api-auth-overlay",
		ProviderID: "pushover",
		...
		SecuritySchemes: []SecurityScheme{
			{
				...
				In:            APIKeyInQuery,
				ParameterName: "token",
				Description:   "Pushover application API token carried in the token request parameter.",
			},
			{
				...
				In:            APIKeyInQuery,
				ParameterName: "user",
				Description:   "Pushover user or group key carried in the user request parameter for message delivery.",
			},
		},
		RootSecurity: []SecurityRequirement{{Scheme: "pushoverAppToken"}, {Scheme: "pushoverUserKey"}},
		RootSecuritySets: []SecurityRequirementSet{{
			Requirements: []SecurityRequirement{{Scheme: "pushoverAppToken"}, {Scheme: "pushoverUserKey"}},
		}},
		SourceRefs: []string{
			"https://pushover.net/api",
			"https://pushover.net/api/client",
		},
		SourceNote: "Pushover has official human API docs but no recorded stable public official OpenAPI document; token and user request parameter metadata comes from advisory overlay notes.",
	},
	{
		ID:         "signl4-api-auth-overlay",
		ProviderID: "signl4",
		...
		SecuritySchemes: []SecurityScheme{{
			...
			Type:          SecuritySchemeAPIKey,
			In:            APIKeyInHeader,
			ParameterName: "X-S4-Api-Key",
			Description:   "SIGNL4 API key carried in the X-S4-Api-Key header.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "signl4APIKey"}},
		SourceRefs: []string{
			"https://connect.signl4.com/api/docs/v1/swagger.json",
			"https://connect.signl4.com/api/docs/index.html",
		},
		SourceNote: "SIGNL4 publishes an official OpenAPI document, but the downloaded document leaves root security anonymous despite API-key documentation; X-S4-Api-Key metadata is carried as catalog overlay guidance.",
	},
	{
		ID:         "sms77-api-auth-overlay",
		ProviderID: "sms77",
		...
		SecuritySchemes: []SecurityScheme{{
			...
			In:            APIKeyInHeader,
			ParameterName: "X-Api-Key",
			Description:   "seven.io API key carried in the X-Api-Key header.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "sevenAPIKey"}},
		SourceRefs: []string{
			"https://docs.seven.io/en/rest-api/authentication",
			"https://docs.seven.io/en/rest-api/endpoints/sms",
		},
	...
	},
	{
		...
		SecuritySchemes: []SecurityScheme{{
			...
			In:            APIKeyInHeader,
			ParameterName: "Authorization",
			Description:   "Emelia API key carried in the Authorization header.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "emeliaAPIKey"}},
		SourceRefs: []string{
			"https://docs-old.emelia.io/",
		},
		SourceNote: "Emelia documents a GraphQL API rather than a stable public official OpenAPI document; Authorization header API-key metadata comes from advisory overlay notes.",
	},
	{
		ID:         "disqus-api-auth-overlay",
		ProviderID: "disqus",
		SpecRefID:  "disqus-auth-docs",
		Status:     AuthStatusOverlayRequired,
		SecuritySchemes: []SecurityScheme{
			{
				Name:          "disqusAccessToken",
				Type:          SecuritySchemeAPIKey,
				In:            APIKeyInQuery,
				ParameterName: "access_token",
				Description:   "Disqus access token carried in the access_token request parameter.",
			},
			{
				Name:          "disqusAPIKey",
				Type:          SecuritySchemeAPIKey,
				In:            APIKeyInQuery,
				ParameterName: "api_key",
				Description:   "Disqus public API key carried in the api_key request parameter for endpoints that allow public-key access.",
			},
		},
		RootSecurity: []SecurityRequirement{{Scheme: "disqusAccessToken"}, {Scheme: "disqusAPIKey"}},
		SourceRefs: []string{
	...
	},
	{
		...
		SecuritySchemes: []SecurityScheme{{
			...
			Type:         SecuritySchemeHTTP,
			Scheme:       "bearer",
			BearerFormat: "Medium access token",
			Description:  "Medium OAuth or integration access token carried in the Authorization bearer header.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "mediumBearer"}},
		SourceRefs: []string{
	...
	},
	{
		...
		SecuritySchemes: []SecurityScheme{{
			...
			Type:         SecuritySchemeHTTP,
			Scheme:       "bearer",
			BearerFormat: "npm access token",
			Description:  "npm registry access token carried in the Authorization bearer header for authenticated registry endpoints.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "npmBearer"}},
		SourceRefs: []string{
			"https://github.com/npm/registry/blob/master/docs/REGISTRY-API.md",
			"https://docs.npmjs.com/cli/v11/using-npm/registry",
		},
		SourceNote: "npm registry docs are human documentation rather than a recorded official OpenAPI document; bearer token metadata comes from registry authentication notes.",
	},
	{
		ID:         "storyblok-api-auth-overlay",
		ProviderID: "storyblok",
		SpecRefID:  "storyblok-content-delivery-api-docs",
		Status:     AuthStatusOverlayRequired,
		SecuritySchemes: []SecurityScheme{
			{
				Name:          "storyblokContentToken",
				Type:          SecuritySchemeAPIKey,
				In:            APIKeyInQuery,
				ParameterName: "token",
				Description:   "Storyblok Content Delivery API token carried in the token query parameter.",
			},
			{
				Name:         "storyblokManagementBearer",
				Type:         SecuritySchemeHTTP,
				Scheme:       "bearer",
				BearerFormat: "Storyblok personal access token",
				Description:  "Storyblok Management API personal access token carried in the Authorization bearer header.",
			},
		},
		RootSecurity: []SecurityRequirement{{Scheme: "storyblokContentToken"}, {Scheme: "storyblokManagementBearer"}},
		SourceRefs: []string{
			"https://www.storyblok.com/docs/api/content-delivery/v2",
			"https://www.storyblok.com/docs/api/management/getting-started/authentication/",
		},
	...
	},
	{
		...
		SecuritySchemes: []SecurityScheme{{
			...
			Type:         SecuritySchemeHTTP,
			Scheme:       "bearer",
			BearerFormat: "Strapi JWT or API token",
			Description:  "Strapi content API JWT or API token carried in the Authorization bearer header.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "strapiBearer"}},
		SourceRefs: []string{
	...
	{
		ID:         "wordpress-rest-api-auth-overlay",
		...
		SecuritySchemes: []SecurityScheme{
			{
				...
				Type:        SecuritySchemeHTTP,
				Scheme:      "basic",
				Description: "WordPress username and application password or password carried with HTTP Basic authentication.",
			},
			{
				Name:         "wordpressBearer",
				Type:         SecuritySchemeHTTP,
				Scheme:       "bearer",
				BearerFormat: "WordPress.com OAuth token",
				Description:  "WordPress.com OAuth access token carried in the Authorization bearer header.",
			},
		},
		RootSecurity: []SecurityRequirement{{Scheme: "wordpressBasic"}, {Scheme: "wordpressBearer"}},
		SourceRefs: []string{
	...
	},
	{
		...
		SecuritySchemes: []SecurityScheme{{
			...
			Type:        SecuritySchemeHTTP,
			Scheme:      "basic",
			Description: "Wufoo API key supplied as the HTTP Basic username with any placeholder password.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "wufooBasic"}},
		SourceRefs: []string{
			"https://www.wufoo.com/docs/api/v3/",
			"https://www.wufoo.com/docs/api/v3/forms/",
		},
	...
	{
		ID:         "yourls-api-auth-overlay",
		ProviderID: "yourls",
		SpecRefID:  "yourls-passwordless-api-docs",
		Status:     AuthStatusOverlayRequired,
		SecuritySchemes: []SecurityScheme{{
			Name:          "yourlsSignature",
			Type:          SecuritySchemeAPIKey,
			In:            APIKeyInQuery,
			ParameterName: "signature",
			Description:   "YOURLS passwordless API signature carried in the signature query parameter.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "yourlsSignature"}},
		SourceRefs: []string{
			"https://yourls.org/docs/guide/advanced/api",
			"https://yourls.org/docs/guide/advanced/passwordless-api",
		},
	...
	},
	{
		...
		SecuritySchemes: []SecurityScheme{{
			...
			Type:         SecuritySchemeHTTP,
			Scheme:       "bearer",
			BearerFormat: "Raindrop.io OAuth token",
			Description:  "Raindrop.io OAuth access token carried in the Authorization bearer header.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "raindropBearer"}},
		SourceRefs: []string{
	...
	{
		ID:         "travis-ci-api-auth-overlay",
		ProviderID: "travis-ci",
		SpecRefID:  "travis-ci-auth-docs",
		Status:     AuthStatusOverlayRequired,
		SecuritySchemes: []SecurityScheme{
			{
				Name:          "travisAuthorization",
				Type:          SecuritySchemeAPIKey,
				In:            APIKeyInHeader,
				ParameterName: "Authorization",
				Description:   "Travis CI API token carried in the Authorization header using token syntax.",
			},
			{
				Name:          "travisAPIVersion",
				Type:          SecuritySchemeAPIKey,
				In:            APIKeyInHeader,
				ParameterName: "Travis-API-Version",
				Description:   "Travis CI API version header required by API v3 requests.",
			},
		},
		RootSecurity: []SecurityRequirement{{Scheme: "travisAuthorization"}, {Scheme: "travisAPIVersion"}},
		RootSecuritySets: []SecurityRequirementSet{{
			Requirements: []SecurityRequirement{{Scheme: "travisAuthorization"}, {Scheme: "travisAPIVersion"}},
		}},
		SourceRefs: []string{
	...
	},
	{
		...
		SecuritySchemes: []SecurityScheme{{
			...
			Type:         SecuritySchemeHTTP,
			Scheme:       "bearer",
			BearerFormat: "Flow personal access token",
			Description:  "Flow personal access token carried in the Authorization bearer header.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "flowBearer"}},
		SourceRefs: []string{
			"https://developer.getflow.com/",
			"https://developer.getflow.com/errors",
		},
	...
	{
		ID:         "gotowebinar-api-auth-overlay",
		...
		SecuritySchemes: []SecurityScheme{{
			Name:        "gotoOAuth2",
			Type:        SecuritySchemeOAuth2,
			Description: "GoTo OAuth2 access token carried in the Authorization bearer header.",
			Flows: []OAuthFlow{{
				Type:             OAuthFlowAuthorizationCode,
		...
		RootSecurity: []SecurityRequirement{{Scheme: "gotoOAuth2"}},
		SourceRefs: []string{
			"https://developer.goto.com/GoToWebinarV2/",
			"https://developer.goto.com/guides/Authentication/",
		},
	...
	},
	{
		...
		SecuritySchemes: []SecurityScheme{{
			Name:        "halopsaOAuth2",
			Type:        SecuritySchemeOAuth2,
			Description: "HaloPSA OAuth2 client credentials access token carried in the Authorization bearer header.",
			Flows: []OAuthFlow{{
				Type:     OAuthFlowClientCredentials,
				TokenURL: "https://{halo_auth_host}/auth/token",
				Scopes:   []string{"admin", "edit:tickets", "edit:customers"},
			}},
			Scopes: []string{"admin", "edit:tickets", "edit:customers"},
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "halopsaOAuth2", Scopes: []string{"admin", "edit:tickets", "edit:customers"}}},
		SourceRefs: []string{
			"https://apidoc.halopsa.com/",
			"https://support.halopsa.com/portal/kb/articles/haloapi",
		},
	...
	{
		ID:         "lonescale-api-auth-overlay",
		ProviderID: "lonescale",
		SpecRefID:  "lonescale-public-api-docs",
		Status:     AuthStatusOverlayRequired,
		SecuritySchemes: []SecurityScheme{{
			Name:          "lonescaleAPIKey",
			Type:          SecuritySchemeAPIKey,
			In:            APIKeyInHeader,
			ParameterName: "X-API-KEY",
			Description:   "LoneScale API key carried in the X-API-KEY request header.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "lonescaleAPIKey"}},
		SourceRefs: []string{
			"https://help-center.lonescale.com/en/articles/6454360-lonescale-public-api",
			"https://public-api.lonescale.com/api",
		},
	...
	},
	{
		...
		SecuritySchemes: []SecurityScheme{{
			...
			Type:        SecuritySchemeHTTP,
			Scheme:      "basic",
			Description: "lemlist API key carried as the HTTP Basic password with an empty username.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "lemlistBasic"}},
		SourceRefs: []string{
	...
	},
	{
		...
		SecuritySchemes: []SecurityScheme{{
			...
			Type:         SecuritySchemeHTTP,
			Scheme:       "bearer",
			BearerFormat: "Orbit API token",
			Description:  "Historical Orbit API token carried in the Authorization bearer header.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "orbitBearer"}},
		SourceRefs: []string{
			"https://docs.orbit.love/reference",
			"https://orbit.love/blog/orbit-is-joining-postman",
		},
		...
		SecuritySchemes: []SecurityScheme{
			{
				...
				Type:          SecuritySchemeAPIKey,
				In:            APIKeyInHeader,
				ParameterName: "xc-auth",
				Description:   "NocoDB auth token carried in the xc-auth request header.",
			},
			{
				Name:          "xc-token",
				Type:          SecuritySchemeAPIKey,
				In:            APIKeyInHeader,
				ParameterName: "xc-token",
				Description:   "NocoDB API token carried in the xc-token request header.",
			},
			{
				Name:         "nocodbBearer",
				Type:         SecuritySchemeHTTP,
				Scheme:       "bearer",
				BearerFormat: "NocoDB API token",
				Description:  "NocoDB API token carried in the Authorization bearer header.",
			},
		},
		RootSecurity: []SecurityRequirement{{Scheme: "xc-auth"}, {Scheme: "xc-token"}, {Scheme: "nocodbBearer"}},
		SourceRefs: []string{
			"https://nocodb.com/apis/v2/swagger-v2.json",
			"https://nocodb.com/docs/product-docs/developer-resources/rest-apis",
			"https://nocodb.com/docs/product-docs/developer-resources/rest-apis/accessing-apis",
			"https://nocodb.com/docs/product-docs/account-settings/api-tokens",
		},
		SourceNote: "NocoDB's official v2 OpenAPI artifact leaves reusable security requirements incomplete for protected operations; official docs describe auth tokens via xc-auth and API tokens via xc-token or Authorization bearer headers, while v2/v3 scheme details still need normalization before complete classification.",
	},
	{
		ID:         "oura-api-auth-overlay",
		ProviderID: "oura",
		...
		SecuritySchemes: []SecurityScheme{{
			...
			Type:         SecuritySchemeHTTP,
			Scheme:       "bearer",
			BearerFormat: "Oura access token",
			Description:  "Oura API access token carried in the Authorization bearer header.",
		}},
		...
		SourceNote: "Oura's official OpenAPI document uses operation security references and examples for BearerAuth but omits the corresponding security scheme definition; this overlay records the missing bearer scheme metadata.",
	},
	{
		ID:         "profitwell-api-auth-overlay",
		ProviderID: "profitwell",
		SpecRefID:  "profitwell-api-v2-docs",
		Status:     AuthStatusOverlayRequired,
		SecuritySchemes: []SecurityScheme{{
			Name:          "profitwellAuthorization",
			Type:          SecuritySchemeAPIKey,
			In:            APIKeyInHeader,
			ParameterName: "Authorization",
			Description:   "ProfitWell private or public API token carried directly in the Authorization header.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "profitwellAuthorization"}},
		SourceRefs: []string{
	...
	{
		ID:         "quickbase-api-auth-overlay",
		ProviderID: "quickbase",
		SpecRefID:  "quickbase-auth-docs",
		Status:     AuthStatusOverlayRequired,
		SecuritySchemes: []SecurityScheme{
			{
				Name:         "quickbaseBearer",
				Type:         SecuritySchemeHTTP,
				Scheme:       "bearer",
				BearerFormat: "Quickbase user token",
				Description:  "Quickbase user token carried in the Authorization bearer header.",
			},
			{
				Name:          "quickbaseRealmHostname",
				Type:          SecuritySchemeAPIKey,
				In:            APIKeyInHeader,
				ParameterName: "QB-Realm-Hostname",
				Description:   "Quickbase realm hostname carried in the QB-Realm-Hostname request header.",
			},
		},
		RootSecuritySets: []SecurityRequirementSet{{
			Requirements: []SecurityRequirement{{Scheme: "quickbaseBearer"}, {Scheme: "quickbaseRealmHostname"}},
		}},
		SourceRefs: []string{
			"https://developer.quickbase.com/",
			"https://help.quickbase.com/docs/authentication-and-secure-access",
			"https://help.quickbase.com/docs/create-and-use-user-tokens",
		},
	...
	},
	{
		...
		SecuritySchemes: []SecurityScheme{{
			...
			Type:         SecuritySchemeHTTP,
			Scheme:       "bearer",
			BearerFormat: "Taiga auth token",
			Description:  "Taiga authentication token carried in the Authorization bearer header after a metadata-only login endpoint exchange.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "taigaBearer"}},
		SourceRefs: []string{
	...
	{
		ID:         "tapfiliate-api-auth-overlay",
		ProviderID: "tapfiliate",
		SpecRefID:  "tapfiliate-api-auth-docs",
		Status:     AuthStatusOverlayRequired,
		SecuritySchemes: []SecurityScheme{{
			Name:          "tapfiliateAPIKey",
			Type:          SecuritySchemeAPIKey,
			In:            APIKeyInHeader,
			ParameterName: "Api-Key",
			Description:   "Tapfiliate API key carried in the Api-Key request header.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "tapfiliateAPIKey"}},
		SourceRefs: []string{
			"https://tapfiliate.com/docs/rest/",
			"https://tapfiliate.com/docs/rest/#authentication",
		},
	...
	},
	{
		...
		SecuritySchemes: []SecurityScheme{{
			...
			Type:        SecuritySchemeHTTP,
			Scheme:      "X-Matrix",
			Description: "Matrix signed request metadata carried with the X-Matrix HTTP Authorization scheme.",
		}},
		OperationSecurity: []OperationSecurity{{
			Match:    OperationMatch{OperationID: "getRoomSummary", Method: "GET", Path: "/_matrix/client/v1/room_summary/{roomIdOrAlias}"},
			Security: []SecurityRequirement{{Scheme: "signedRequest"}},
		}},
		SourceRefs: []string{
		...
		SourceNote: "Matrix's official Client-Server API OpenAPI document defines reusable bearer and query access-token schemes but references an undeclared signedRequest scheme for getRoomSummary. Matrix server-server auth docs describe signed requests in the Authorization header with the X-Matrix scheme; this overlay records the reviewed operation-level reference as metadata only.",
	},
	{
		...
		SecuritySchemes: []SecurityScheme{{
			...
			In:            APIKeyInHeader,
			ParameterName: "Authorization",
			Description:   "SyncroMSP API key supplied through the Authorization header in the official API docs UI.",
		}},
		OperationSecurity: []OperationSecurity{{
			Match:    OperationMatch{Method: "GET", Path: "/callerid"},
			Security: []SecurityRequirement{{Scheme: "apiKey"}},
		}},
		SourceRefs: []string{
			"https://api-docs.syncromsp.com/swagger.json",
			"https://api-docs.syncromsp.com/",
		},
		SourceNote: "SyncroMSP's official OpenAPI document defines bearerAuth but one operation references apiKey. This overlay records the reviewed Authorization-header API key reference without resolving user-specific keys or subdomains.",
	},
	{
		...
		SecuritySchemes: []SecurityScheme{
			{
				...
				Type:        SecuritySchemeHTTP,
				Scheme:      "bearer",
				Description: "TheHive API key supplied as an Authorization bearer token.",
			},
			{
				Name:        "Basic",
				Type:        SecuritySchemeHTTP,
				Scheme:      "basic",
				Description: "TheHive username and password supplied with HTTP Basic authentication.",
			},
			{
				Name:          "Session",
				Type:          SecuritySchemeAPIKey,
				In:            APIKeyInCookie,
				ParameterName: "THEHIVE-SESSION",
				Description:   "TheHive browser session cookie used by the frontend, not preferred for automation.",
			},
		},
		RootSecuritySets: []SecurityRequirementSet{
			{Requirements: []SecurityRequirement{{Scheme: "ApiKey"}}},
			{Requirements: []SecurityRequirement{{Scheme: "Basic"}}},
			{Requirements: []SecurityRequirement{{Scheme: "Session"}}},
		},
		SourceRefs: []string{
			"https://docs.strangebee.com/thehive/api-docs/docs.yaml",
			"https://docs.strangebee.com/thehive/api-docs/",
		},
		SourceNote: "TheHive 5 official OpenAPI document declares ApiKey, Basic, and Session schemes but some operation requirements reference Api Key with a space. This overlay records the reusable scheme names from the same source; credential and organisation selection remain downstream.",
	},
	{
		...
		SecuritySchemes: []SecurityScheme{{
			...
			Type:        SecuritySchemeHTTP,
			Scheme:      "basic",
			Description: "Zulip REST API HTTP Basic authentication with email as username and API key as password.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "basicAuth"}},
		SourceRefs: []string{
			"https://raw.githubusercontent.com/zulip/zulip/main/zerver/openapi/zulip.yaml",
			"https://docs.zulip.com/api/rest",
		},
		SourceNote: "Zulip's official OpenAPI components define BasicAuth while root and operation requirements reference basicAuth. This overlay records the reviewed lowercase requirement name and HTTP Basic credential placement.",
	},
	{
	...
	},
	{
		...
		SecuritySchemes: []SecurityScheme{{
			...
			In:            APIKeyInHeader,
			ParameterName: "X-API-Key",
			Description:   "Postman API key supplied in the X-API-Key request header.",
		}},
		RootSecurity: []SecurityRequirement{{Scheme: "postmanAPIKey"}},
		SourceRefs: []string{
		...
		SourceNote: "Postman has official human API docs but no recorded stable provider-owned OpenAPI artifact; docs describe X-API-Key header authentication, retained here as advisory metadata only.",
	},
}
