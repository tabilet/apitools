...
var builtInProviders = []Provider{
	...
	providerCatalogEntry(providerSeed{
		...
		quirks: []string{"Snowflake publishes SQL API and expanding REST API human docs; M13 review did not find a stable public downloadable official OpenAPI document.", "Snowflake account URLs, regions, and authentication methods are account-specific and must be supplied downstream by the operator."},
	}),
	providerCatalogEntry(providerSeed{
		id:                  "splunk",
		displayName:         "Splunk",
