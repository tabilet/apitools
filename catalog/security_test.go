...
func TestBuiltInSecurityOverlaysValidate(t *testing.T) {
	...
	if got, want := len(overlays), BuiltInCatalogManifest().SecurityOverlayCount; got != want {
...
func TestBuiltInSecurityReportDeterministic(t *testing.T) {
	...
	wantStatuses := map[string]AuthCompletenessStatus{
		...
		"amplitude":                         AuthStatusOverlayRequired,
		"anthropic":                         AuthStatusOverlayRequired,
		"apollo":                            AuthStatusOverlayRequired,
		"asana":                             AuthStatusPresentIncomplete,
		"ashby":                             AuthStatusOverlayRequired,
		"attio":                             AuthStatusComplete,
		"auth0":                             AuthStatusComplete,
		"autopilot":                         AuthStatusOverlayRequired,
		"aws-acm":                           AuthStatusOverlayRequired,
		"aws-api-gateway":                   AuthStatusOverlayRequired,
		"aws-athena":                        AuthStatusOverlayRequired,
		"aws-bedrock":                       AuthStatusOverlayRequired,
		"aws-cloudwatch":                    AuthStatusOverlayRequired,
		"aws-cognito":                       AuthStatusOverlayRequired,
		"aws-comprehend":                    AuthStatusOverlayRequired,
		"aws-dynamodb":                      AuthStatusOverlayRequired,
		"aws-ec2":                           AuthStatusOverlayRequired,
		"aws-elb":                           AuthStatusOverlayRequired,
		"aws-elbv2":                         AuthStatusOverlayRequired,
		"aws-glue":                          AuthStatusOverlayRequired,
		"aws-guardduty":                     AuthStatusOverlayRequired,
		"aws-iam":                           AuthStatusOverlayRequired,
		"aws-inspector2":                    AuthStatusOverlayRequired,
		"aws-kinesis":                       AuthStatusOverlayRequired,
		"aws-kms":                           AuthStatusOverlayRequired,
		"aws-lambda":                        AuthStatusOverlayRequired,
		"aws-rds":                           AuthStatusOverlayRequired,
		"aws-rekognition":                   AuthStatusOverlayRequired,
		"aws-s3":                            AuthStatusOverlayRequired,
		"aws-sagemaker":                     AuthStatusOverlayRequired,
		"aws-secrets-manager":               AuthStatusOverlayRequired,
		"aws-securityhub":                   AuthStatusOverlayRequired,
		...
		"braze":                             AuthStatusOverlayRequired,
		...
		"postman":                           AuthStatusOverlayRequired,
