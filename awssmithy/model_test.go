...
func TestCatalogAWSArtifactsRemainSmithyReviewArtifacts(t *testing.T) {
	for _, path := range []string{
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-acm-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-cognito-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-comprehend-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-dynamodb-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-elb-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-elbv2-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-iam-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-lambda-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-rekognition-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-s3-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-ses-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-sns-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-sqs-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-textract-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-transcribe-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-api-gateway-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-athena-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-bedrock-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-cloudwatch-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-ec2-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-glue-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-guardduty-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-inspector2-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-kinesis-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-kms-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-rds-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-sagemaker-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-secrets-manager-smithy-model.json"),
		filepath.Join("..", "catalog-openapi-cache", "aws-smithy", "aws-securityhub-smithy-model.json"),
	} {
